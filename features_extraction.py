...
"""finding lbp of image to extract features """
eps=1e-7
...
"""program is only for features extraction from the face if you want add the extracted features from the database
refer database program intial program will be same only data base part is add"""
